...
[![Tested](https://img.shields.io/badge/tested-2.1.185-brightgreen.svg)](CHANGELOG_ZH.md)
...
| `bash test-check-update.sh` | 跑更新偵測測試套件（18 tests） |
...
evap-shield/
  ...
  test-check-update.sh  # 更新偵測測試（18 tests）
